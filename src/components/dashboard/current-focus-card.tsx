export function CurrentFocusCard() {
  return (
    <article className="relative flex min-h-[320px] flex-col overflow-hidden border border-white/[0.04] bg-[#18181a] p-6 sm:p-7">
      ...
      <div className="mt-auto flex flex-wrap items-end justify-between gap-4 border-t border-white/[0.045] pt-8">
        <div className="flex flex-wrap gap-2 text-xs">
          <span className="border border-white/[0.06] bg-[#202022] px-2.5 py-1.5 text-white/54">Word count: 1,486</span>
          <span className="border border-white/[0.06] bg-[#202022] px-2.5 py-1.5 text-white/54">Progress: 74% locked</span>
          <span className="border border-white/[0.06] bg-[#202022] px-2.5 py-1.5 text-white/54">Last revision: 22:41 UTC</span>
        </div>
