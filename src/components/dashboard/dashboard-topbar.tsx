...
export function DashboardTopbar() {
  return (
    <header className="flex h-14 items-center justify-between border-b border-white/[0.04] px-5 sm:px-7 lg:px-8">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="hidden h-8 w-48 items-center rounded-[6px] border border-white/[0.035] bg-white/[0.01] px-3 text-xs text-white/32 sm:flex">
          Search manuscripts
        </div>
